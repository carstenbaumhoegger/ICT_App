            ...
            switch (status) {
                case LoaderCallbackInterface.SUCCESS:
                {
                    ...
                    try {
                        ...
                        //todo InputStream is3 = context.getResources().openRawResource(R.raw.haarcascade_frontalface_default);
...
*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //gets called in onResume OpenCVLoader.initAsync(OpenCVLoader.OPENCV_VERSION_2_4_4, this, mLoaderCallback);
    }
